...
public class Events extends javax.swing.JFrame {
    ...
    private void SaveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveButtonActionPerformed
        ...
        try{
            ...
            cs= con.prepareCall("insert into event (ev_tr_id,ev_start,ev_end,ev_descr)values(?,?,?,?)");
    ...
    private void UpdateButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateButton2ActionPerformed
        ...
        try{
            ...
            pst= con.prepareStatement("update event set ev_tr_id =? ,ev_start=? , ev_end=?, ev_descr=? WHERE ev_tr_id =? and ev_start =?");
    ...
    private void DeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteButtonActionPerformed
        ...
        try{
            ...
            pst= con.prepareStatement("delete from event WHERE ev_tr_id =? and ev_start=? ");
